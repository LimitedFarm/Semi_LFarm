...
<script>
	        ...
	        function openChild1() {
	            // window.name = "부모창 이름"; 
	            window.name = "PListUpdate.jsp";
	            // window.open("open할 window", "자식창 이름", "팝업창 옵션");
	            window.open("PopupUpdate.jsp",
...
<body>
	...
	<form action = "<%=request.getContextPath()%>/insert.bo" method="post" encType="multipart/form-data">
		...
		<div class="layer">
			...
			<div class="mainInfo">
				<div id="imgArea">
					<img src=<%=img %> id="titleImg" width="465px" height="460px" name="pMainimg">
				</div>
			...
			<br><br><br><br>
				<div class="dearArea">
					<div id="List">
	   						<font size="5em" color="black" style="font-family: Noto Serif KR">판매 물품명 : </font> 
	   						<input type="text" name="pName" style=" width:305px; height:30px; font-size:20px; color:red; border: 0px;" id="pInput1" readonly="readonly" value=<%=name %>>
	   						 <font size="5em" color="black" style="font-family: Noto Serif KR"">가격 : </font>
	   						 <input type="text" name="pPrice" style=" width:150px; text-align:right; font-size:20px; color:red; border: 0px;" id="pInput2" readonly="readonly" value=<%=price %>>원<br>
	   						 <font size="4em" color="black" style="font-family: Noto Serif KR"">재고량 : </font> 
	   						 <input type="text" name="pCount" style=" width:150px; text-align:right; font-size:18px; color:black; border: 0px;" id="pInput3" readonly="readonly" value=<%=count %>>개<br>
	   						 <font size="4em" color="black" style="font-family: Noto Serif KR""> 원산지 : </font>
							 <input type="text" size="30" id="add1" name="add1" style="font-size:18px; color:black; border: 0px;" readonly="readonly" value="<%=add%>"><br>
	   						 <font size="3em" color="black" style="font-family: Noto Serif KR">생산일자 : </font> 
	   						 <input type="date" id="pInput5" name="pDay" value="<%=day%>" style="font-size:15px; color:black; border: 0px;" readonly="readonly"><br>
	   						 <font size="3em" color="black" style="font-family: Noto Serif KR">유통기한 : </font> 
	   						 <input type="date" id="pInput6" name="pPeriod" value="<%=period %>" style="font-size:15px; color:black; border: 0px;" readonly="readonly">
 
   					<div>
   						<button type="button" id="resetAlls" style="margin-left: 100px">모든 내용 지우기</button>
	   					<input type="button" value="기본정보 입력하기" onclick="openChild1()" style="margin-left: 40px">
   					</div>
		...
		<div class="mainArea">
			...
			<div id="sList2" style="margin-left: auto; margin-right: auto; margin-top: 20px; border: 1px solid; border-color: #ddd #ddd #CACACA;">
				상품 유의사항 작성
				<textarea name="pNotice" rows="10" cols="130" style="width: 927px; height: 250px"><%=notice%></textarea>
			</div>
			
			<div id="sList3" style="margin-left: auto; margin-right: auto; margin-top: 20px; border: 1px solid; border-color: #ddd #ddd #CACACA;">
				배송 유의사항 작성
				<textarea name="pDelivery" rows="10" cols="130" style="width: 927px; height: 250px"><%=delivery%></textarea>
			</div>
