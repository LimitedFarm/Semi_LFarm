...
<title>기본 정보등록</title>
    ...
    <script type="text/javascript">
        function setParentText(){
        	...
        	var add = document.getElementById("sample6_address").value + document.getElementById("sample6_detailAddress").value + document.getElementById("sample6_extraAddress").value;
            ...
            opener.document.getElementById("add1").value = add
