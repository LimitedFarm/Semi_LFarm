 ...
 * Generated at: 2019-10-16 18:44:55 UTC
...
public final class apiSampleJSON_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$(\"#list\").html(\"\");\r\n");
      out.write("\t\t\tvar errCode = jsonStr.results.common.errorCode;\r\n");
      out.write("\t\t\tvar errDesc = jsonStr.results.common.errorMessage;\r\n");
      out.write("\t\t\tif(errCode != \"0\"){\r\n");
      out.write("\t\t\t\talert(errCode+\"=\"+errDesc);\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tif(jsonStr != null){\r\n");
      out.write("\t\t\t\t\tmakeListJson(jsonStr);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function makeListJson(jsonStr){\r\n");
      out.write("\tvar htmlStr = \"\";\r\n");
      out.write("\thtmlStr += \"<table>\";\r\n");
      out.write("\t$(jsonStr.results.juso).each(function(){\r\n");
      out.write("\t\thtmlStr += \"<tr>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.roadAddr+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.roadAddrPart1+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.roadAddrPart2+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.jibunAddr+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.engAddr+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.zipNo+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.admCd+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.rnMgtSn+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.bdMgtSn+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.detBdNmList+\"</td>\";\r\n");
      out.write("\t\t/** API 서비스 제공항목 확대 (2017.02) **/\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.bdNm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.bdKdcd+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.siNm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.sggNm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.emdNm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.liNm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.rn+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.udrtYn+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.buldMnnm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.buldSlno+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.mtYn+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.lnbrMnnm+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.lnbrSlno+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"<td>\"+this.emdNo+\"</td>\";\r\n");
      out.write("\t\thtmlStr += \"</tr>\";\r\n");
      out.write("\t});\r\n");
      out.write("\thtmlStr += \"</table>\";\r\n");
      ...
      out.write("\t<input type=\"text\" name=\"resultType\" value=\"json\"/> <-- 요청 변수 설정 (검색결과형식 설정, json) --> \r\n");
